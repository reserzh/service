    ...
    categories: [
      {
        ...
        features: [
          ...
          { name: "Role-adaptive sidebar", description: "Technicians get a simplified 3-item sidebar (Dashboard, Jobs, Daily Reports) for clutter-free field use", status: "complete" },
          { name: "Crew requests widget", description: "Morning briefing widget showing material requests, equipment issues, and notes from crew end-of-day reports", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Technician assignment", description: "Single or multiple technician assignment to jobs with crew-level notifications to all assigned members", status: "complete" },
          ...
          { name: "Job checklists", description: "Configurable task checklists with template auto-apply on dispatch", status: "complete" },
          { name: "Equipment packing lists", description: "Job-type-specific tool/equipment lists auto-applied on dispatch — crew checks off what they have before heading out", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "AI photo area estimation", description: "Claude Vision analyzes job site photos to estimate sqft with confidence levels and zone detection", status: "complete" },
          { name: "BOM auto-generation", description: "Auto-generate bill of materials from job type + dimensions using template formulas or AI pricebook matching", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Media library", description: "Image and file upload to Supabase Storage with gallery view, copy URL, and delete with confirmation", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Triggered notifications", description: "Auto-send emails on estimate sent, invoice sent, job scheduled, etc. with technician photo and bio in dispatch/en-route emails", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Vision area estimation", description: "Claude Vision analyzes job site photos to estimate area dimensions with confidence levels", status: "complete" },
          { name: "AI bill of materials", description: "AI generates material lists by matching job descriptions to tenant pricebook catalog", status: "complete" },
        ],
      },
      {
        ...
        features: [
          ...
          { name: "Checklist templates", description: "Reusable job checklists with auto-apply rules, pre-built landscaping templates for 8 job types", status: "complete" },
          { name: "Equipment list templates", description: "Job-type-specific tool/equipment packing lists with auto-apply on dispatch — separate from task checklists", status: "complete" },
          ...
          { name: "QuickBooks integration", description: "OAuth connection, sync invoices/customers/estimates/payments with tax mapping, bulk sync all, and error tracking", status: "complete" },
          ...
          { name: "Bill of materials auto-generation", description: "Select a job type + dimensions to auto-generate materials list from BOM templates with quantity formulas, AI fallback for unlisted job types", status: "complete" },
          { name: "BOM estimate templates", description: "Estimate templates with jobType matching, quantity formulas (area, perimeter, posts), and auto-apply for Pergola, Paver, Turf, Fence, Sod jobs", status: "complete" },
          { name: "Booking availability", description: "Configure day-of-week time windows for when quote requests are accepted on public website", status: "complete" },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        features: [
          ...
          { name: "Next job card", description: "Highlighted upcoming job with one-tap GO button and auto-present next job after completion", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Equipment packing list", description: "Job-type-specific tool/equipment list shown before task checklist — orange-accented with packed/unpacked tracking", status: "complete" },
          ...
          { name: "Budget progress indicator", description: "Visual budget used % bar on job overview for in-progress and completed jobs with labor/material breakdown", status: "complete" },
      ...
      },
      {
        ...
        features: [
          ...
          { name: "AI photo area measurement", description: "Take a photo of the job site, AI estimates sqft with confidence badge, pre-fills area calculator", status: "complete" },
          { name: "Bill of materials step", description: "Select job type + dimensions to auto-generate materials list with template or AI-powered BOM", status: "complete" },
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Geofencing", description: "Auto-navigates to job detail screen when arriving at property (100m radius) — no tap required in foreground, notification tap in background", status: "complete" },
        ],
      },
      {
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Biometric lock", description: "Session timeout with biometric re-authentication, configurable via profile settings toggle", status: "complete" },
          { name: "Push notifications", description: "Expo push delivery to devices on job assignment, status changes, and other events with auto-cleanup of expired tokens", status: "complete" },
        ],
      },
      {
    ...
    categories: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: "Multi-property view", description: "Jobs grouped by property with status counts and expandable lists for property managers", status: "complete" },

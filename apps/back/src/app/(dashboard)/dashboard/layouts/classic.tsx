...
> = {
  ...
  executive: {
    wrapper: "dark rounded-xl bg-gray-950 p-4 text-gray-100",
    card: "bg-gray-900 border-gray-800 text-gray-100",
    cardHover: "hover:shadow-md hover:shadow-indigo-500/5 hover:border-gray-700",
    statIcon: {
    ...
    quickAction: "hover:border-indigo-500/30",
    quickActionIcon: "bg-indigo-500/15 text-indigo-400",
    sectionIcon: "text-indigo-400",
    dot: "bg-indigo-400/50",
    muted: "text-gray-400",
    scheduleItem: "hover:bg-gray-800/60",
    emptyIcon: "text-gray-600",
  },
  arctic: {
    wrapper: "",
    card: "border-gray-100 shadow-none bg-white",
    cardHover: "hover:shadow-sm hover:border-gray-200",
    statIcon: {
    ...
    quickAction: "hover:border-slate-300",
    quickActionIcon: "bg-slate-100 text-slate-500",
    sectionIcon: "text-slate-500",
    dot: "bg-slate-300",
    muted: "text-slate-400",
    scheduleItem: "hover:bg-slate-50",
    emptyIcon: "text-slate-300",
  },
  ocean: {
    wrapper: "rounded-xl bg-blue-50/50 p-4",
    card: "border-blue-100 bg-white",
    cardHover: "hover:shadow-md hover:shadow-blue-100/50 hover:border-blue-200",
    statIcon: {
    ...
    quickAction: "hover:border-blue-300",
    quickActionIcon: "bg-blue-100 text-blue-600",
    sectionIcon: "text-blue-600",
    dot: "bg-blue-400/50",
    muted: "text-blue-400",
    scheduleItem: "hover:bg-blue-50/50",
...
function StatCard({
  ...
  const card = (
    <Card className={cn(v.card, href && `transition-shadow ${v.cardHover} cursor-pointer`)}>

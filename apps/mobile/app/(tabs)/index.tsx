...
import { ClipboardList, Play, CheckCircle2, DollarSign } from "lucide-react-native";
        ...
        ListHeaderComponent={
          <View className="pt-2 pb-4">
            ...
            <View className="flex-row gap-3 mb-5">
              ...
              <Animated.View className="flex-1" entering={FadeInDown.delay(240).duration(400).springify()}>
                <StatCard
...
function StatCard({
  ...
  return (
    <View
      className={`rounded-2xl p-3 ${bgClass}`}

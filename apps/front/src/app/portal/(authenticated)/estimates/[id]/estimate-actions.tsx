        ...
        <div className="mb-6">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {options.map((opt) => (
              ...
              >
                {opt.isRecommended && (
                  <span className="absolute -top-2.5 right-3 inline-flex items-center rounded-full bg-blue-600 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white">
                    Recommended
                  </span>
                )}

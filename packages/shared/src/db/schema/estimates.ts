...
export const estimates = fieldserviceSchema.table(
  "estimates",
  {
...
export const estimateOptions = fieldserviceSchema.table(
  "estimate_options",
  {
    id: uuid("id").primaryKey().defaultRandom(),
    tenantId: uuid("tenant_id")
...
export const estimateOptionItems = fieldserviceSchema.table(
